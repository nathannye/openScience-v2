...
!(function (e, t) {
  ...
  var g,
    ...
    M = function _setDoc(e) {
      ...
      !(b in e.style) &&
        ...
        (w = (b = "msTransform") + "Origin");
      for (; t.parentNode && (t = t.parentNode); );
      if (((u = window), (m = new he()), t)) {
        (i = (g = t).documentElement), (r = t.body);
    ...
    R = function _placeSiblings(e, t) {
      var o,
        ...
        p = e.parentNode;
      if (e === u) return e;
      if ((d.length || d.push(v(e, 1), v(e, 2), v(e, 3)), (o = l ? f : h), l))
        (i = c ? { x: 0, y: 0 } : e.getBBox()),
        ...
        if ("absolute" !== (s = u.getComputedStyle(e)).position)
  ...
  function getGlobalMatrix(e, t, o, n) {
    if (!e || !e.parentNode || (g || M(e)).documentElement === e)
      return new he();
    var i = k(e),
      r = C(e) ? D : S,
      a = R(e, o),
  ...
  function pa(e, t) {
    for (var o, n = e.length; n--; )
      t
        ...
        (o = e[n].children) && o.length && pa(o, t);
  }
  function qa() {
  ...
  function sa() {
    return !Ie.length && fe.ticker.remove(qa);
  }
  function ta(e) {
    for (var t = Ie.length; t--; ) Ie[t] === e && Ie.splice(t, 1);
    fe.to(sa, {
      overwrite: !0,
      delay: 15,
      duration: 0,
  ...
  function za(e) {
    (ke = e.touches && Me < e.touches.length), wa(e.target, "touchend", za);
  }
  function Aa(e) {
    (ke = e.touches && Me < e.touches.length), va(e.target, "touchend", za);
  }
  function Ba(e) {
    return (
      me.pageYOffset ||
  ...
  function Da(e, t) {
    va(e, "scroll", t), Oe(e.parentNode) || Da(e.parentNode, t);
  }
  function Ea(e, t) {
    wa(e, "scroll", t), Oe(e.parentNode) || Ea(e.parentNode, t);
  }
  function Ga(e, t) {
  ...
  function Qa(i, r, e, t, a, o) {
    ...
    if (r)
      if (1 !== a && r instanceof Array) {
        if (((c.end = n = []), (l = r.length), W(r[0])))
          for (s = 0; s < l; s++) n[s] = na(r[s], a);
  ...
  function Sa(e, t) {
    for (var o, n = e.length; n--; )
      ((o = e[n]).ondragstart = o.onselectstart = t ? null : Y),
      ...
      (this.calibrate = function (e) {
        ...
        (f = r.scrollTop),
          ...
          (i &&
            ...
            (u.width = "100%"),
            (u.paddingRight = y + "px"),
            I && (u.paddingBottom = t.paddingBottom),
            (a = r.clientWidth),
            (s = r.clientHeight),
            (v = r.scrollWidth),
            (x = r.scrollHeight),
  ...
  var fe,
    ...
    p = {},
    Fe = {},
    H = function _getElementBounds(e, t) {
      t = we(t)[0];
      var o,
        n,
        i,
  ...
  function Draggable(g, p) {
    ...
    function ii(e) {
      if (U.autoScroll && U.isDragging && (ee || P)) {
        var t,
          o,
          n,
          i,
          ...
          ee = !1,
            ...
            Ae.scrollLeft =
              null != me.pageXOffset
                ...
                : ce.body.scrollLeft,
            i = U.pointerX - Ae.scrollLeft,
            r = U.pointerY - Ae.scrollTop;
          c && !o;

        )
          (t = (o = Oe(c.parentNode)) ? Ae : c.parentNode),
            (n = o
              ? {
      ...
      if (P) {
        var p = U.x,
          u = U.y;
        K
          ? ((U.deltaX = p - parseFloat(se.rotation)),
            (U.rotation = p),
            (se.rotation = p + "deg"),
            se.renderTransform(1, se))
          : h
          ? (j && ((U.deltaY = u - h.top()), h.top(u)),
            q && ((U.deltaX = p - h.left()), h.left(p)))
          : G
          ? (j && ((U.deltaY = u - parseFloat(se.y)), (se.y = u + "px")),
            q && ((U.deltaX = p - parseFloat(se.x)), (se.x = p + "px")),
            se.renderTransform(1, se))
          : (j &&
              ((U.deltaY = u - parseFloat(g.style.top || 0)),
              (g.style.top = u + "px")),
            q &&
              ((U.deltaX = p - parseFloat(g.style.left || 0)),
              (g.style.left = p + "px"))),
          !f ||
            e ||
            A ||
            (!(A = !0) === Ma(U, "drag", "onDrag") &&
              (q && (U.x -= U.deltaX), j && (U.y -= U.deltaY), ii(!0)),
            (A = !1));
      }
      P = !1;
    }
    function ji(e, t) {
      ...
      g._gsap || (se = fe.core.getCache(g)),
        ...
        G
          ? ((U.x = parseFloat(se.x)), (U.y = parseFloat(se.y)))
          : K
          ? (U.x = U.rotation = parseFloat(se.rotation))
          : h
          ? ((U.y = h.top()), (U.x = h.left()))
          : ((U.y = parseFloat(g.style.top || ((n = Ja(g)) && n.top)) || 0),
            (U.x = parseFloat(g.style.left || (n || {}).left) || 0)),
        (R || N || I) &&
          !t &&
          ...
          (I &&
            ((Be.x = U.x),
            (Be.y = U.y),
            (o = I(Be)).x !== U.x && ((U.x = o.x), (P = !0)),
            o.y !== U.y && ((U.y = o.y), (P = !0))),
          R &&
            (o = R(U.x)) !== U.x &&
            ((U.x = o), K && (U.rotation = o), (P = !0)),
          N && ((o = N(U.y)) !== U.y && (U.y = o), (P = !0))),
        P && ii(!0),
        e ||
          ((U.deltaX = U.x - i),
          (U.deltaY = U.y - r),
          Ma(U, "throwupdate", "onThrowUpdate"));
    }
    function ki(a, s, l, o) {
      return (
        null == s && (s = -Re),
        ...
        V(a)
          ...
          : Pe(a)
          ? function (e) {
              for (var t, o, n = a.length, i = 0, r = Re; -1 < --n; )
                (o = (t = a[n]) - e) < 0 && (o = -o),
                  o < r && s <= t && t <= l && ((i = n), (r = o));
              return a[i];
            }
    ...
    function mi() {
      ...
      (k = !1),
        h
          ? (h.calibrate(),
            (U.minX = S = -h.maxScrollLeft()),
            (U.minY = E = -h.maxScrollTop()),
            (U.maxX = D = U.maxY = L = 0),
            (k = !0))
          : p.bounds &&
            ((e = Na(p.bounds, g.parentNode)),
            K
              ? ((U.minX = S = e.left),
                (U.maxX = D = e.left + e.width),
                (U.minY = E = U.maxY = L = 0))
              : X(p.bounds.maxX) && X(p.bounds.maxY)
              ? ((t = Na(g, g.parentNode)),
                (U.minX = S = Math.round(Ch(d, "px") + e.left - t.left - 0.5)),
                (U.minY = E = Math.round(Ch(J, "px") + e.top - t.top - 0.5)),
                (U.maxX = D = Math.round(S + (e.width - t.width))),
                (U.maxY = L = Math.round(E + (e.height - t.height))))
              : ((e = p.bounds),
                (U.minX = S = e.minX),
                (U.minY = E = e.minY),
                (U.maxX = D = e.maxX),
                (U.maxY = L = e.maxY)),
            D < S && ((U.minX = D), (U.maxX = D = S), (S = U.minX)),
            L < E && ((U.minY = L), (U.maxY = L = E), (E = U.minY)),
            K && ((U.minRotation = S), (U.maxRotation = D)),
            (k = !0)),
        p.liveSnap &&
          ((o = !0 === p.liveSnap ? p.snap || {} : p.liveSnap),
          (n = Pe(o) || V(o)),
          K
            ? ((R = ki(n ? o : o.rotation, S, D, 1)), (N = null))
            : o.points
            ? (I = (function buildPointSnapFunc(l, s, c, d, p, u, g) {
                return (
                  (u = u && u < Re ? u * u : Re),
                  V(l)
                    ? function (e) {
                        var t,
                          o,
                          n,
                          i = U.isPressed ? 1 - U.edgeResistance : 1,
                          r = e.x,
                          a = e.y;
                        return (
                          (e.x = r =
                    ...
                    ? function (e) {
                        for (
                          var t, o, n, i, r = l.length, a = 0, s = Re;
                          -1 < --r;
              ...
              })(n ? o : o.points, S, D, E, L, o.radius, h ? -1 : 1))
            : (q &&
                (R = ki(
    ...
    function ni() {
      (U.isThrowing = !1), Ma(U, "throwcomplete", "onThrowComplete");
    }
    function oi() {
      U.isThrowing = !1;
    }
    function pi(e, t) {
      ...
      e && Se
        ? (!0 === e &&
            ...
            K
              ? (e.rotation = Qa(U, n ? o : o.rotation, D, S, 1, t))
              : (q &&
                  (e[d] = Qa(
                    U,
                ...
                (o.points || (Pe(o) && W(o[0]))) &&
                  ((e.linkedProps = d + "," + J), (e.radius = o.radius)))),
          (U.isThrowing = !0),
    ...
    function ri() {
      ...
      qi(!1),
        ...
        (b = Fe.x),
        (w = Fe.y),
        P && (ue(U.pointerX, U.pointerY), ii(!0)),
        h
          ? (mi(), (M = h.top()), (T = h.left()))
          : (de() ? (ji(!0, !0), mi()) : U.applyBounds(),
            K
              ? ((e = g.ownerSVGElement
                ...
                (o = C.y - U.pointerY + r),
                (T = U.x),
                (M = U.y = Math.atan2(o, t) * Xe))
              : ((M = Ch(J, "px")), (T = Ch(d, "px")))),
        k &&
          n &&
          (D < T ? (T = D + (T - D) / n) : T < S && (T = S - (S - T) / n),
          K ||
            (L < M ? (M = L + (M - L) / n) : M < E && (M = E - (E - M) / n))),
        (U.startX = T = _(T)),
        (U.startY = M = _(M));
    }
    function ti() {
      !ye.parentNode || de() || U.isDragging || ye.parentNode.removeChild(ye);
    }
    function ui(e, t) {
      var o;
      if (
        ...
        if (
          ...
          (Ee && y) ||
            (va(ce, "mouseup", ge),
            e && e.target && va(e.target, "mouseup", ge)),
          (x = re.call(U, e.target) && !1 === p.dragClickables && !t))
        )
          return (
            va(e.target, "change", ge),
            Ma(U, "pressInit", "onPressInit"),
            Ma(U, "press", "onPress"),
            Sa(Z, !0),
            void (F = !1)
          );
        if (
          ((H =
            !(
              ...
              (U.vars.allowContextMenu && e && (e.ctrlKey || 2 < e.which))
            ) && (q ? "y" : "x")),
          (F = !H && !U.allowEventDefault) &&
            (xa(e), va(me, "touchforcechange", xa)),
          e.changedTouches
          ...
          (function _addToRenderQueue(e) {
            Ie.push(e), 1 === Ie.length && fe.ticker.add(qa);
          })(ii),
          (w = U.pointerY = e.pageY),
          (b = U.pointerX = e.pageX),
          Ma(U, "pressInit", "onPressInit"),
          (H || U.autoScroll) && Ha(g.parentNode),
          !g.parentNode ||
            !U.autoScroll ||
            h ||
            K ||
          ...
          (!p.zIndexBoost && (K || h || !1 === p.zIndexBoost)) ||
            (g.style.zIndex = Draggable.zIndex++),
          (U.isPressed = !0),
          (f = !(!p.onDrag && !U._listeners.drag)),
          (l = !(!p.onMove && !U._listeners.move)),
    ...
    function yi(e) {
      if (e && U.isDragging && !h) {
        ...
        (o || n) &&
          (z
            ? ((b -= o * z.a + n * z.c), (w -= n * z.d + o * z.b))
            : ((b -= o), (w -= n)),
          (t._gsScrollX += o),
          (t._gsScrollY += n),
          ue(U.pointerX, U.pointerY));
      }
    }
    function zi(e) {
      var t = Ne(),
        ...
        n = t - $ < 40,
        i = o && O === ae,
        r = U.pointerEvent && U.pointerEvent.defaultPrevented,
        a = o && c === ae,
        s = e.isTrusted || (null == e.isTrusted && o && i);
      if (
        ((i || (n && !1 !== U.vars.suppressClickOnDrag)) &&
        ...
        return s && i && (c = ae), void (O = ae);
      (U.isPressed || n || o) && ((s && e.detail && o && !r) || xa(e)),
        o ||
          n ||
          (e && e.target && (U.pointerEvent = e), Ma(U, "click", "onClick"));
    }
    function Ai(e) {
      return z
    ...
    var u,
      ...
      j = !(!~o.indexOf("y") && !~o.indexOf("top") && "scroll" !== o),
      Q = p.minimumMovement || 2,
      U = (function _assertThisInitialized(e) {
        if (void 0 === e)
      ...
      pe = function onMove(e) {
        ...
        if (u && !ke && U.isPressed && e) {
          ...
          (o = Fe.x),
          (n = Fe.y),
          (((r = Math.abs(o - b)) !== (a = Math.abs(n - w)) &&
            (Q < r || Q < a)) ||
            (De && H === B)) &&
            ((B = a < r && q ? "x" : "y"),
            H && B !== H && va(me, "touchforcechange", xa),
            !1 !== U.vars.lockAxisOnTouchScroll &&
              q &&
              j &&
              ((U.lockedAxis = "x" === B ? "y" : "x"),
              V(U.vars.onLockAxis) && U.vars.onLockAxis.call(U, s)),
            De && H === B))
            ? ge(s)
            : ((F =
                U.allowEventDefault ||
      ...
      ue = function setPointerPosition(e, t, o) {
        var n,
          ...
          s,
          l,
          c = 1 - U.dragResistance,
          d = 1 - U.edgeResistance,
          p = U.pointerX,
          u = U.pointerY,
          g = M,
          h = U.x,
        ...
        (U.pointerX = e),
          ...
          le && ((e -= Ca(ce)), (t -= Ba(ce))),
          K
            ? ((a = Math.atan2(C.y - t, e - C.x) * Xe),
              180 < (s = U.y - a)
                ? ((M -= 360), (U.y = a))
                : s < -180 && ((M += 360), (U.y = a)),
              (r =
                U.x !== T || Math.abs(M - a) > Q
                  ? ((U.y = a), T + (M - a) * c)
                  : T))
            : (z &&
                ((l = e * z.a + t * z.c + z.e),
              ...
              (U.lockAxis || U.lockedAxis) &&
                ...
                ((l = U.lockedAxis) ||
                  ((U.lockedAxis = l =
                    q && Math.abs(n) > Math.abs(i) ? "y" : j ? "x" : null),
                  l &&
                    V(U.vars.onLockAxis) &&
          ...
          (R || N || I) && (U.x !== r || (U.y !== a && !K))
            ...
            : k &&
              (D < r
                ? (r = D + Math.round((r - D) * d))
                : r < S && (r = S + Math.round((r - S) * d)),
              K ||
                (L < a
          ...
          (U.x === r && (U.y === a || K)) ||
            (K
              ? ((U.endRotation = U.x = U.endX = r), (P = !0))
              : (j && ((U.y = U.endY = a), (P = !0)),
                q && ((U.x = U.endX = r), (P = !0))),
            o && !1 === Ma(U, "move", "onMove")
              ? ((U.pointerX = p),
                (U.pointerY = u),
                (M = g),
                (U.x = h),
              ...
              : !U.isDragging &&
                U.isPressed &&
                ((U.isDragging = !0), Ma(U, "dragstart", "onDragStart")));
      },
      ge = function onRelease(e, t) {
        if (
          ...
          var o,
            ...
            s = e,
            l = U.isDragging,
            c = U.vars.allowContextMenu && e && (e.ctrlKey || 2 < e.which),
            d = fe.delayedCall(0.001, ti);
          if (
            (y
              ? (wa(y, "touchend", onRelease),
                ...
                wa(ce, "touchstart", Aa))
              : wa(ce, "mousemove", pe),
            wa(me, "touchforcechange", xa),
            (Ee && y) ||
              (wa(ce, "mouseup", onRelease),
              e && e.target && wa(e.target, "mouseup", onRelease)),
            (P = !1),
            l && (($ = He = Ne()), (U.isDragging = !1)),
            x && !c)
          )
            return (
              e && (wa(e.target, "change", onRelease), (U.pointerEvent = s)),
              Sa(Z, !1),
              Ma(U, "release", "onRelease"),
              Ma(U, "click", "onClick"),
              void (x = !1)
            );
          if ((ta(ii), !K))
            for (n = Z.length; -1 < --n; )
              Ia(Z[n], "cursor", p.cursor || (!1 !== p.cursor ? Le : null));
          if ((Me--, e)) {
            if (
              (o = e.changedTouches) &&
              (e = o[0]) !== m &&
          ...
          return (
            c && s
              ? (xa(s), (F = !0), Ma(U, "release", "onRelease"))
              : s && !l
              ? ((F = !1),
                Y && (p.snap || p.bounds) && pi(p.inertia || p.throwProps),
                Ma(U, "release", "onRelease"),
                (De && "touchmove" === s.type) ||
                  -1 !== s.type.indexOf("cancel") ||
                  (Ma(U, "click", "onClick"),
                  Ne() - ae < 300 && Ma(U, "doubleclick", "onDoubleClick"),
                  (r = s.target || g),
                  (ae = Ne()),
              ...
              : (pi(p.inertia || p.throwProps),
                U.allowEventDefault ||
                !s ||
                (!1 === p.dragClickables && re.call(U, s.target)) ||
                !l ||
                (H && (!B || H !== B)) ||
                !1 === s.cancelable
                  ? (F = !1)
                  : ((F = !0), xa(s)),
                Ma(U, "release", "onRelease")),
            de() && d.duration(U.tween.duration()),
            l && Ma(U, "dragend", "onDragEnd"),
            !0
          );
        }
        F && e && u && xa(e);
    ...
    return (
      ...
      (e.startDrag = function (e, t) {
        var o, n, i, r;
        ui(e || U.pointerEvent, !0),
          t &&
            !U.hitTest(e || U.pointerEvent) &&
            ((o = La(e || U.pointerEvent)),
            (n = La(g)),
            (i = Ai({ x: o.left + o.width / 2, y: o.top + o.height / 2 })),
            (r = Ai({ x: n.left + n.width / 2, y: n.top + n.height / 2 })),
            (b -= i.x - r.x),
            (w -= i.y - r.y)),
          U.isDragging ||
            ((U.isDragging = !0), Ma(U, "dragstart", "onDragStart"));
      ...
      (e.endDrag = function (e) {
        return ge(e || U.pointerEvent, !0);
      }),
      (e.timeSinceDrag = function () {
        return U.isDragging ? 0 : (Ne() - $) / 1e3;
      }),
      (e.timeSinceClick = function () {
        return (Ne() - ae) / 1e3;
      }),
      (e.hitTest = function (e, t) {
        return Draggable.hitTest(U.target, e, t);
      }),
      (e.getDirection = function (e, t) {
        var o,
          ...
          a,
          s,
          l = "velocity" === e && Se ? e : W(e) && !K ? "element" : "start";
        return (
          "element" === l && ((a = La(U.target)), (s = La(e))),
          (o =
            "start" === l
              ? U.x - T
              : "velocity" === l
      ...
      (e.applyBounds = function (e, t) {
        var o, n, i, r, a, s;
        if (e && p.bounds !== e) return (p.bounds = e), U.update(!0, t);
        if ((ji(!0), mi(), k && !de())) {
          if (
            ((o = U.x),
            (n = U.y),
            ...
            (U.x !== o || U.y !== n) &&
              ((i = !0),
              (U.x = U.endX = o),
              K ? (U.endRotation = o) : (U.y = U.endY = n),
              ii((P = !0)),
            ...
            for (
              ...
              (a = (s = Oe(r.parentNode)) ? Ae : r.parentNode),
                j &&
                ...
                (r = a);
          U.isThrowing &&
            (i || U.endX > D || U.endX < S || U.endY > L || U.endY < E) &&
            pi(p.inertia || p.throwProps, i);
        }
        return U;
      }),
      (e.update = function (e, t, o) {
        ...
        return (
          qi(!t),
          e ? U.applyBounds() : (P && o && ii(!0), ji(!0)),
          t && (ue(U.pointerX, U.pointerY), P && ii(!0)),
          U.isPressed &&
            !t &&
            ((q && 0.01 < Math.abs(n - U.x)) ||
              (j && 0.01 < Math.abs(i - U.y) && !K)) &&
            ri(),
          U.autoScroll &&
            (Ha(g.parentNode, U.isDragging),
            (ee = U.isDragging),
            ii(!0),
            Ea(g, yi),
            Da(g, yi)),
        ...
        if (
          ...
          for (
            ...
            (n = Z[o]),
              ...
              p.allowContextMenu || va(n, "contextmenu", hi);
          Sa(Z, !1);
        }
        return (
          Da(g, yi),
          ...
          Se &&
            "soft" !== e &&
            Se.track(h || g, G ? "x,y" : K ? "rotation" : "top,left"),
          (g._gsDragID = t = "d" + Ye++),
          (ze[t] = U),
          h && (h.enable(), (h.element._gsDragID = t)),
          (p.bounds || K) && ri(),
          p.bounds && U.applyBounds(),
          U
        );
      }),
      (e.disable = function (e) {
        var t,
          o,
          n = U.isDragging;
        if (!K) for (t = Z.length; -1 < --t; ) Ia(Z[t], "cursor", null);
        if ("soft" !== e) {
          for (pa(Z, null), t = Z.length; -1 < --t; )
            (o = Z[t]),
              Ia(o, "touchCallout", null),
              wa(o, "mousedown", ui),
              wa(o, "touchstart", ui),
              wa(o, "click", zi),
              wa(o, "contextmenu", hi);
        ...
        return (
          ...
          Se &&
            "soft" !== e &&
            Se.untrack(h || g, G ? "x,y" : K ? "rotation" : "top,left"),
          h && h.disable(),
          ta(ii),
          (U.isDragging = U.isPressed = x = !1),
          n && Ma(U, "dragend", "onDragEnd"),
          U
        );
      }),
      (e.enabled = function (e, t) {
        return arguments.length ? (e ? U.enable(t) : U.disable(t)) : u;
      }),
      (e.kill = function () {
        return (
          (U.isThrowing = !1),
          U.tween && U.tween.kill(),
          U.disable(),
          fe.set(Z, { clearProps: "userSelect" }),
      ...
      ~o.indexOf("scroll") &&
        ...
        (g.style.overflowY = j && !_e ? "auto" : "hidden"),
        (g.style.overflowX = q && !_e ? "auto" : "hidden"),
        (g = h.content)),
      K ? (n.rotation = 1) : (q && (n[d] = 1), j && (n[J] = 1)),
  ...
  function ob() {
    return J || (nb() && (J = window.gsap) && J.registerPlugin && J);
  }
  function pb(e) {
  ...
  function zb(e, t, o) {
    var n = j.createElementNS
      ? j.createElementNS("svg" === e ? F : G, e)
      : j.createElement(e);
    return (
      t && (pb(t) && (t = j.querySelector(t)), t.appendChild(n)),
      "svg" === e &&
  ...
  function Ab() {
    j.selection
      ? j.selection.empty()
      : A.getSelection && A.getSelection().removeAllRanges();
  }
  function Cb(e, t) {
    var o = 0,
      ...
      return (
        (i = function handler(e) {
          "select" !== e.target.nodeName.toLowerCase() && e.type === r
            ? (e.stopPropagation(), pe && (e.preventDefault(), o.call(t, e)))
            : e.type !== r && o.call(t, e),
            (pe = !0);
        }),
  ...
  function Kb(e, t, o, n) {
    ...
    n &&
      ((i = zb("option", e)).setAttribute("value", t),
      (i.innerHTML = o.innerHTML = pb(n) ? n : t),
    ...
    if (te) {
      for (e = Z._dur; n; )
        (t = n._next),
          ...
          (qb(o) && o === n.vars.onComplete && !n._dur) ||
            (o && o._gsIgnore) ||
            Z.add(n, n._start - n._delay),
          (n = t);
      return e !== Z.duration();
    }
  }
  function Pb(e) {
    return J.getById(e) || ne.getById(e) || (e === Z.vars.id && Z);
  }
  function Qb(e) {
    (J = e || ob()),
      q ||
        (J &&
          ...
          (A = window),
          J.registerPlugin(K),
          ((O = J.globalTimeline)._sort = !0),
          (O.autoRemoveChildren = !1),
          ($ = J.core.Animation),
          (ne = J.timeline({
            data: "indy",
          ...
          (O.killTweensOf = function (e, t, o) {
            Z.killTweensOf(e, t, o), Z.killTweensOf.call(O, e, t, o);
          }),
          ...
          (ie = function _delayedCall(e, t, o, n) {
            ...
            return te ? te.update() : Mb();
          }),
          ie(2, function () {
            var e, t, o;
            if (!te)
              for (Mb(), e = Z._first, o = Z._start; e; )
                (t = e._next),
                  e._tDur !== e._tTime || (!e._dur && 1 !== e.progress())
                    ? O.add(e, e._start - e._delay + o)
                    : e.kill(),
                  (e = t);
  ...
  var J,
    ...
    ue = function GSDevTools(r) {
      q || (Qb(), J || console.warn("Please gsap.registerPlugin(GSDevTools)")),
        (this.vars = r = r || {}),
        r.animation &&
          (
        ...
        (r.id = r.id || (pb(r.animation) ? r.animation : le++)),
        (ce[r.id + ""] = this),
      ...
      function yo(e) {
        if (!I.isPressed) {
          ...
          v.progress(o / 100).pause(), H(!0), I.startDrag(e);
        }
      }
      function Co() {
        if (!I.isPressed) {
      ...
      function Fo() {
          ...
          o = (function _getChildrenOf(e, t) {
            for (var o = [], n = 0, i = J.core.Tween, r = e._first; r; )
              r instanceof i
                ...
                (r = r._next);
            return o;
          })(a && !r.globalSync ? a : Z, !0),
          n = L.children,
          i = 0;
        for (
          a && !r.globalSync
            ? o.unshift(a)
            : r.hideGlobalTimeline || o.unshift(Z),
            t = 0;
          t < o.length;
          t++
        )
          ((e = n[t] || zb("option", L)).animation = o[t]),
        ...
        for (; t < n.length; t++) L.removeChild(n[t]);
      }
      function Go(e) {
        var t,
          o,
          n = parseFloat(R.options[R.selectedIndex].value) || 1;
        ...
        if (
          ...
          if (
            ...
            (M.style.left = D + "%"),
            (k.style.left = S + "%"),
            c && (Ln("animation", i.vars.id), Ln("in", D), Ln("out", S)),
            (s = 0),
            (o = r.maxDuration || Math.min(1e3, Cb(i))),
            i === Z || r.globalSync)
          ) {
            if (
              (Mb(),
            ...
            } else (v = i), !d && v._repeat && Do(!0);
            v.timeScale(n), ee.pause(), Z.resume(), v.seek(0);
          }
          (_.innerHTML = v.duration().toFixed(2)), Kb(L, i.vars.id, E);
        }
      }
      function Io(e) {
        Go(L.options[L.selectedIndex].animation),
          e.target && e.target.blur && e.target.blur(),
          C && B();
      }
      function Jo() {
        var e,
          t = parseFloat(R.options[R.selectedIndex].value) || 1;
        v.timeScale(t),
          Ln("timeScale", t),
          C ||
            (v.progress() >= S / 100
      ...
      function Ro(e) {
        ae && !se && (se = Z._start),
          ...
          Mb(),
          Fo();
        var t = Pb(Mn("animation"));
        t &&
          ((t._inProgress = Mn("in") || 0),
          (t._outProgress = Mn("out") || 100)),
          r.paused && A(),
          (i = null),
          Go(a || t || Z);
        var o = r.timeScale || Mn("timeScale"),
          n = t === i;
        o && (Kb(R, o, N, o + "x"), v.timeScale(o)),
          100 ===
            (D =
              ("inTime" in r ? Eb(r.inTime, i, 0, 0) : n ? t._inProgress : 0) ||
              0) &&
            !r.animation &&
            t &&
            (Go(Z), (D = Eb(r.inTime, i, 0, 0) || 0)),
          D &&
            ((M.style.left = D + "%"),
            (M.style.display = k.style.display = "block")),
          (S =
            ("outTime" in r
              ? Eb(r.outTime, i, 100, D)
              : n
              ? t._outProgress
              : 0) || 100) < D && (S = 100),
          100 !== S &&
            ((k.style.left = S + "%"),
            (M.style.display = k.style.display = "block")),
          (d = "loop" in r ? r.loop : Mn("loop")) && Do(!0),
          r.paused && v.progress(D / 100, !0).pause(),
          ae && i === Z && se && r.globalSync && !C && v.time(-se, !0),
          H(!0);
      }
      var u,
        g,
        ...
        n = (function _createRootElement(e, t, o) {
          re ||
            ...
            (re = !0)),
            pb(e) && (e = j.querySelector(e));
          var n = zb("div", e || Q.getElementsByTagName("body")[0] || Q);
          return (
        ...
        R = Kn(".time-scale select"),
        N = Kn(".time-scale-label"),
        I = K.create(x, {
          type: "x",
          cursor: "ew-resize",
      ...
      Ib(L, "change", Io),
        Ib(L, "mousedown", Fo),
        Ib(t, "mousedown", O),
        Ib(Kn(".seek-bar"), "mousedown", yo),
        Ib(Kn(".rewind"), "mousedown", Co),
        Ib(P, "mousedown", Eo),
        Ib(R, "change", Jo),
        "auto" === r.visibility
          ? (Ib(n, "mouseout", Mo), Ib(n, "mouseover", Oo))
        ...
        (this.update = function (e) {
          te === p &&
            ...
            (function updateRootDuration() {
              ...
              i === Z &&
                ((e = Z._time),
                Z.progress(1, !0).time(e, !0),
                (e = (ee._dp._time - ee._start) * ee._ts),
                1e3 === (o = Math.min(1e3, Z.duration())) &&
                  (o = Math.min(1e3, Cb(Z))),
                1 != (t = ee.duration() / o) &&
                  o &&
                  ((D *= t),
        ...
        (this.kill = function () {
          Jb(L, "change", Io),
            Jb(L, "mousedown", Fo),
            Jb(t, "mousedown", O),
            Jb(Kn(".seek-bar"), "mousedown", yo),
            Jb(Kn(".rewind"), "mousedown", Co),
            Jb(P, "mousedown", Eo),
            Jb(R, "change", Jo),
            I.disable(),
            z.disable(),
  ...
  (ue.version = "3.6.1"),
    ...
    (ue.getByAnimation = function (e) {
      for (var t in (pb(e) && (e = J.getById(e)), ce))
        if (ce[t].animation() === e) return ce[t];
    }),
    (ue.create = function (e) {
      return new ue(e);
    }),
    (ue.register = Qb),
    ob() && J.registerPlugin(ue),
    (e.GSDevTools = ue),
    (e.default = ue);
